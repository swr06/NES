...
void NESEmu::ShaderManager::CreateShaders()
{
	AddShader("BLIT", "Core/Shaders/FBOVert.vert", "Core/Shaders/Blit.frag");
}

void NESEmu::ShaderManager::AddShader(const std::string& name, const std::string& vert, const std::string& frag, const std::string& geo)
{
...
void NESEmu::ShaderManager::AddComputeShader(const std::string& name, const std::string& comp)
{
...
GLClasses::Shader& NESEmu::ShaderManager::GetShader(const std::string& name)
{
	auto exists = ShaderManager_ShaderMap.find(name);
...
GLClasses::ComputeShader& NESEmu::ShaderManager::GetComputeShader(const std::string& name)
{
	auto exists = ShaderManager_ShaderMapC.find(name);
...
GLuint NESEmu::ShaderManager::GetShaderID(const std::string& name)
{
	auto exists = ShaderManager_ShaderMap.find(name);
...
void NESEmu::ShaderManager::RecompileShaders()
{
...
void NESEmu::ShaderManager::ForceRecompileShaders()
{
	for (auto& e : ShaderManager_ShaderMap)
	{
